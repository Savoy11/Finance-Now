...
| Surface | Status | Provider(s) | Cadence | Route |
|---------|--------|-------------|---------|-------|
| Source discovery (all news pages) | Partial | Anthropic web_search (server-side) _(key)_ | — | `/live-data/news-discovery` |
