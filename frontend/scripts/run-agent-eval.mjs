...
async function main() {
  ...
  console.log(`  agent model          claude-sonnet-4-6 (the default in lib/agents/prompts.ts, for all 11)`)
  console.log('')
  ...
  const md = [
    ...
    `Base: ${BASE} · model: \`claude-sonnet-4-6\` (default for all 11) · run at ${stamp}`,
    '',
