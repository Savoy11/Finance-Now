...
export const DATA_SOURCES: DataSourceEntry[] = [
  ...
  },
  {
    ...
    providers: [
      ...
      { name: 'LBank', host: 'api.lbkex.com', url: 'https://www.lbank.com/support/articles/21436496711705', role: 'primary', auth: 'none' },
