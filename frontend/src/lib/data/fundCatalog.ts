...
//
// ── T-070 / D27, 2026-09-26: fourteen rows added; six sector SPDRs 0.09 → 0.08 ──
//
// XLC XLP XLY XLB · VCSH VMBS VTIP EMLC BKLN · VSS VGK EWJ VYMI HEFA. Every row was
// probed on the owner's machine BEFORE it was written: quotable through the app's own
// ladder (finnhub), 22 daily closes to 2026-09-25 (tiingo), and an expense ratio read
// from the fund's own SEC Risk/Return filing — never a neighbour's row, never memory.
// Accession numbers per row: docs/audits/fund-candidates-probe-2026-09-26.md.
//
// Where a filing carries a contractual waiver (EMLC, BKLN, HEFA) the row holds the NET
// figure and its description says so — waivers expire, so that is the number to re-check.
//
// aumB is the ETF share class, not the whole fund: Vanguard fact sheets as of
// 2026-06-30 (their ETFs are share classes of larger index funds — VTIP is $19B as an
// ETF inside a $71B fund), SSGA product pages as of 2026-09-24, iShares screener feed
// as of 2026-09-25, VanEck page as of 2026-09-25, N-PORT for Invesco (one series per
// ETF, so the figures coincide). yieldPct: trailing-12-month distributions over the
// 2026-09-25 close for Vanguard (computed from the issuer's distribution records),
// issuer-published trailing/distribution yield for SSGA, iShares and Invesco, and the
// 30-day SEC yield for EMLC because VanEck publishes no distribution yield on the page.
//
// The 0.08: the Select Sector SPDR Trust's 485BPOS of 2026-01-28 (0001193125-26-027312)
// states 0.08% total annual fund operating expenses for all eleven funds. The six rows
// already here said 0.09, confirmed on 2026-09-01 against the archive that was newest
// THEN. `npm run fund-fees` reads only the newest quarterly archive, and a fund appears
// only in the quarter it files, so a January fee cut is invisible to a September run
// against the 2026q2 archive. T-411 records that reach problem.
//
// The stamp below does NOT move: fourteen new rows and six corrected fees do not
// re-verify the other 120.
...
export const FUND_CATALOG: FundEntry[] = [
  ...
  // ── T-070 / D27 additions, 2026-09-26 — verified quotable + actively trading + fee-sourced first (docs/audits/fund-candidates-probe-2026-09-26.md) ──
  { symbol: 'VSS',  name: 'Vanguard FTSE All-World ex-US Small-Cap ETF', type: 'etf', issuer: 'Vanguard', category: 'international', expenseRatioPct: 0.06, aumB: 12, referencePrice: 157, yieldPct: 3.4, inceptionYear: 2009, indexTracked: 'FTSE Global Small Cap ex US', topHoldings: [], website: 'https://investor.vanguard.com/investment-products/etfs/profile/vss', description: 'International small caps, developed and emerging — the non-US counterpart to IWM.' },
  { symbol: 'VGK',  name: 'Vanguard FTSE Europe ETF',            type: 'etf', issuer: 'Vanguard', category: 'international', expenseRatioPct: 0.06, aumB: 30, referencePrice: 89, yieldPct: 2.9, inceptionYear: 2005, indexTracked: 'FTSE Developed Europe All Cap', topHoldings: [], website: 'https://investor.vanguard.com/investment-products/etfs/profile/vgk', description: 'Developed Europe as a region — the one slice VEA and EFA do not let you hold on its own.' },
  { symbol: 'EWJ',  name: 'iShares MSCI Japan ETF',              type: 'etf', issuer: 'BlackRock', category: 'international', expenseRatioPct: 0.49, aumB: 23, referencePrice: 98, yieldPct: 3.7, inceptionYear: 1996, indexTracked: 'MSCI Japan', topHoldings: [], website: 'https://www.ishares.com/us/products/239665/ishares-msci-japan-etf', description: 'Japan on its own — the largest single country weight inside VEA and EFA.' },
  { symbol: 'VYMI', name: 'Vanguard International High Dividend Yield ETF', type: 'etf', issuer: 'Vanguard', category: 'international', expenseRatioPct: 0.07, aumB: 20, referencePrice: 103, yieldPct: 3.6, inceptionYear: 2016, indexTracked: 'FTSE All-World ex US High Dividend Yield', topHoldings: [], website: 'https://investor.vanguard.com/investment-products/etfs/profile/vymi', description: 'Non-US large caps screened for high dividend yield — the international counterpart to VYM. Filed under international (D27): the currency exposure is the risk the band describes.' },
  { symbol: 'HEFA', name: 'iShares Currency Hedged MSCI EAFE ETF', type: 'etf', issuer: 'BlackRock', category: 'international', expenseRatioPct: 0.35, aumB: 8, referencePrice: 47, yieldPct: 3.1, inceptionYear: 2014, indexTracked: 'MSCI EAFE 100% Hedged to USD', topHoldings: [], website: 'https://www.ishares.com/us/products/259622/ishares-currency-hedged-msci-eafe-etf', description: 'Developed international with the currency exposure hedged back to dollars — holds EFA plus FX forwards. Expense ratio is net of a contractual waiver (0.70% gross, 0.32 of it the underlying fund fee counted twice).' },
  // ── Sector ETFs ──────────────────────────────────────────────────────────────
  { symbol: 'XLK',  name: 'Technology Select Sector SPDR',     type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 80, referencePrice: 270, yieldPct: 0.6, inceptionYear: 1998, indexTracked: 'Technology Select Sector', topHoldings: [ { symbol: 'NVDA', name: 'NVIDIA', weightPct: 15 }, { symbol: 'MSFT', name: 'Microsoft', weightPct: 14 }, { symbol: 'AAPL', name: 'Apple', weightPct: 13 }, { symbol: 'AVGO', name: 'Broadcom', weightPct: 6 }, { symbol: 'ORCL', name: 'Oracle', weightPct: 3 } ], website: 'https://www.sectorspdrs.com/mainfund/xlk', description: 'S&P 500 technology sector slice.', focusSector: 'technology', focusIndustry: 'Software, hardware & semiconductors' },
  { symbol: 'XLF',  name: 'Financial Select Sector SPDR',      type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 50, referencePrice: 53, yieldPct: 1.4, inceptionYear: 1998, indexTracked: 'Financial Select Sector', topHoldings: [ { symbol: 'BRK-B', name: 'Berkshire Hathaway', weightPct: 13 }, { symbol: 'JPM', name: 'JPMorgan Chase', weightPct: 10 }, { symbol: 'V', name: 'Visa', weightPct: 7 }, { symbol: 'MA', name: 'Mastercard', weightPct: 6 }, { symbol: 'BAC', name: 'Bank of America', weightPct: 4 } ], website: 'https://www.sectorspdrs.com/mainfund/xlf', description: 'S&P 500 financials: banks, payments, insurers.', focusSector: 'financials', focusIndustry: 'Banks, insurers & payments' },
  { symbol: 'XLE',  name: 'Energy Select Sector SPDR',         type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 35, referencePrice: 92, yieldPct: 3.3, inceptionYear: 1998, indexTracked: 'Energy Select Sector', topHoldings: [ { symbol: 'XOM', name: 'Exxon Mobil', weightPct: 22 }, { symbol: 'CVX', name: 'Chevron', weightPct: 16 }, { symbol: 'COP', name: 'ConocoPhillips', weightPct: 8 }, { symbol: 'SLB', name: 'SLB', weightPct: 4 }, { symbol: 'EOG', name: 'EOG Resources', weightPct: 4 } ], website: 'https://www.sectorspdrs.com/mainfund/xle', description: 'S&P 500 energy sector — oil majors and services.', focusSector: 'energy', focusIndustry: 'Oil, gas & energy services' },
  { symbol: 'XLV',  name: 'Health Care Select Sector SPDR',    type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 40, referencePrice: 150, yieldPct: 1.6, inceptionYear: 1998, indexTracked: 'Health Care Select Sector', topHoldings: [ { symbol: 'LLY', name: 'Eli Lilly', weightPct: 12 }, { symbol: 'JNJ', name: 'Johnson & Johnson', weightPct: 8 }, { symbol: 'ABBV', name: 'AbbVie', weightPct: 7 }, { symbol: 'UNH', name: 'UnitedHealth', weightPct: 6 }, { symbol: 'MRK', name: 'Merck', weightPct: 5 } ], website: 'https://www.sectorspdrs.com/mainfund/xlv', description: 'S&P 500 healthcare: pharma, insurers, devices.', focusSector: 'healthcare', focusIndustry: 'Pharma, insurers & med-tech' },
  { symbol: 'XLI',  name: 'Industrial Select Sector SPDR',     type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 20, referencePrice: 150, yieldPct: 1.3, inceptionYear: 1998, indexTracked: 'Industrial Select Sector', topHoldings: [], website: 'https://www.sectorspdrs.com/mainfund/xli', description: 'S&P 500 industrials: aerospace, machinery, transport.', focusSector: 'industrials', focusIndustry: 'Aerospace, machinery & transport' },
  { symbol: 'XLU',  name: 'Utilities Select Sector SPDR',      type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 20, referencePrice: 84, yieldPct: 2.7, inceptionYear: 1998, indexTracked: 'Utilities Select Sector', topHoldings: [], website: 'https://www.sectorspdrs.com/mainfund/xlu', description: 'S&P 500 utilities; data-center power demand theme.', focusSector: 'utilities', focusIndustry: 'Electric & multi-utilities' },
  ...
  // ── T-070 / D27 additions, 2026-09-26 — the four GICS sectors the catalog could not tilt toward (see portfolioBuilder SECTOR_ETF) ──
  { symbol: 'XLC',  name: 'Communication Services Select Sector SPDR', type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 23, referencePrice: 113, yieldPct: 1.2, inceptionYear: 2018, indexTracked: 'Communication Services Select Sector', topHoldings: [ { symbol: 'META', name: 'Meta Platforms', weightPct: 20 }, { symbol: 'GOOGL', name: 'Alphabet Class A', weightPct: 13 }, { symbol: 'GOOG', name: 'Alphabet Class C', weightPct: 10 }, { symbol: 'TTWO', name: 'Take-Two Interactive', weightPct: 5 }, { symbol: 'NFLX', name: 'Netflix', weightPct: 5 } ], website: 'https://www.sectorspdrs.com/mainfund/xlc', description: 'S&P 500 communication services: interactive media, telecom, entertainment.', focusSector: 'communication-services', focusIndustry: 'Interactive media, telecom & entertainment' },
  { symbol: 'XLP',  name: 'Consumer Staples Select Sector SPDR',       type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 14, referencePrice: 82, yieldPct: 2.7, inceptionYear: 1998, indexTracked: 'Consumer Staples Select Sector', topHoldings: [ { symbol: 'WMT', name: 'Walmart', weightPct: 11 }, { symbol: 'COST', name: 'Costco', weightPct: 9 }, { symbol: 'PG', name: 'Procter & Gamble', weightPct: 7 }, { symbol: 'KO', name: 'Coca-Cola', weightPct: 7 }, { symbol: 'PM', name: 'Philip Morris', weightPct: 6 } ], website: 'https://www.sectorspdrs.com/mainfund/xlp', description: 'S&P 500 consumer staples: food, beverage, household products, staples retail.', focusSector: 'consumer-staples', focusIndustry: 'Food, beverage, household & staples retail' },
  { symbol: 'XLY',  name: 'Consumer Discretionary Select Sector SPDR', type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 22, referencePrice: 111, yieldPct: 0.9, inceptionYear: 1998, indexTracked: 'Consumer Discretionary Select Sector', topHoldings: [ { symbol: 'AMZN', name: 'Amazon', weightPct: 22 }, { symbol: 'TSLA', name: 'Tesla', weightPct: 20 }, { symbol: 'HD', name: 'Home Depot', weightPct: 6 }, { symbol: 'MCD', name: 'McDonald\u2019s', weightPct: 4 }, { symbol: 'TJX', name: 'TJX Companies', weightPct: 4 } ], website: 'https://www.sectorspdrs.com/mainfund/xly', description: 'S&P 500 consumer discretionary: e-commerce, autos, retail, restaurants, travel.', focusSector: 'consumer-discretionary', focusIndustry: 'E-commerce, autos, retail & restaurants' },
  { symbol: 'XLB',  name: 'Materials Select Sector SPDR',              type: 'etf', issuer: 'State Street', category: 'sector', expenseRatioPct: 0.08, aumB: 8, referencePrice: 50, yieldPct: 1.7, inceptionYear: 1998, indexTracked: 'Materials Select Sector', topHoldings: [ { symbol: 'LIN', name: 'Linde', weightPct: 14 }, { symbol: 'NEM', name: 'Newmont', weightPct: 6 }, { symbol: 'FCX', name: 'Freeport-McMoRan', weightPct: 5 }, { symbol: 'CTVA', name: 'Corteva', weightPct: 5 }, { symbol: 'SHW', name: 'Sherwin-Williams', weightPct: 5 } ], website: 'https://www.sectorspdrs.com/mainfund/xlb', description: 'S&P 500 materials: industrial gases, chemicals, metals & mining.', focusSector: 'materials', focusIndustry: 'Chemicals, metals & mining' },
  // ── Bond ETFs ────────────────────────────────────────────────────────────────
  ...
  // ── T-070 / D27 additions, 2026-09-26 — exposures with no representative above ──
  { symbol: 'VCSH', name: 'Vanguard Short-Term Corporate Bond ETF', type: 'etf', issuer: 'Vanguard', category: 'bond', expenseRatioPct: 0.03, aumB: 45, referencePrice: 77, yieldPct: 4.6, inceptionYear: 2009, indexTracked: 'Bloomberg US 1-5 Year Corporate', topHoldings: [], website: 'https://investor.vanguard.com/investment-products/etfs/profile/vcsh', description: 'Short-term (1–5 year) investment-grade corporate credit — the short end of the ladder LQD does not cover.' },
  { symbol: 'VMBS', name: 'Vanguard Mortgage-Backed Securities ETF', type: 'etf', issuer: 'Vanguard', category: 'bond', expenseRatioPct: 0.03, aumB: 16, referencePrice: 45, yieldPct: 4.4, inceptionYear: 2009, indexTracked: 'Bloomberg US MBS Float Adjusted', topHoldings: [], website: 'https://investor.vanguard.com/investment-products/etfs/profile/vmbs', description: 'Agency mortgage-backed securities (GNMA, FNMA, FHLMC) as a standalone holding — BND and AGG carry them only inside the aggregate.' },
  { symbol: 'VTIP', name: 'Vanguard Short-Term Inflation-Protected Securities ETF', type: 'etf', issuer: 'Vanguard', category: 'bond', expenseRatioPct: 0.03, aumB: 19, referencePrice: 49, yieldPct: 4.2, inceptionYear: 2012, indexTracked: 'Bloomberg US Treasury TIPS 0-5 Year', topHoldings: [], website: 'https://investor.vanguard.com/investment-products/etfs/profile/vtip', description: 'Short-duration TIPS — inflation protection without the long-bond duration of TIP.' },
  { symbol: 'EMLC', name: 'VanEck J.P. Morgan EM Local Currency Bond ETF', type: 'etf', issuer: 'VanEck', category: 'bond', expenseRatioPct: 0.30, aumB: 5, referencePrice: 25, yieldPct: 6.4, inceptionYear: 2010, indexTracked: 'J.P. Morgan GBI-EM Global Core', topHoldings: [], website: 'https://www.vaneck.com/us/en/investments/jp-morgan-em-local-currency-bond-etf-emlc/', description: 'Emerging-market sovereign debt in LOCAL currencies — credit risk plus FX risk, unlike the dollar-denominated EMB and VWOB. Expense ratio is net of a contractual waiver (0.31% gross).' },
  { symbol: 'BKLN', name: 'Invesco Senior Loan ETF',                  type: 'etf', issuer: 'Invesco', category: 'bond', expenseRatioPct: 0.65, aumB: 6, referencePrice: 21, yieldPct: 6.4, inceptionYear: 2011, indexTracked: 'Morningstar LSTA US Leveraged Loan 100', topHoldings: [], website: 'https://www.invesco.com/us/en/financial-products/etfs/invesco-senior-loan-etf.html', description: 'Senior secured floating-rate bank loans — below investment grade, and the coupon resets with short rates; the only floating-rate row here. Filed under bond by owner ruling (D27). Expense ratio is net of a contractual waiver (0.67% gross).' },
